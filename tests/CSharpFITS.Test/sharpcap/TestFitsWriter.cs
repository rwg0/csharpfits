...
namespace CSharpFITS_v1._1.tests.sharpcap
{
    ...
    public class TestFitsWriter
    {
        ...
        {
            private readonly int _significantBitDepth;
            private readonly ColourSpaceId _colourSpaceId;
            private readonly short _bytesPerPixel;
            private readonly Size _size;
            private readonly int _colourPlanes;
